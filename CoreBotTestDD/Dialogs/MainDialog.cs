    ...
    public class MainDialog : ComponentDialog
    {
        ...
        private async Task<DialogTurnResult> IntroStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            if (userProfile.IsNewUser)
            {
                ...
                await stepContext.Context.SendActivityAsync(MessageFactory.Text("¡Hola, bienvenido a la Fundación Santa Fe de Bogotá!. Al continuar, aceptas nuestros términos y condiciones https://bit.ly/3ZWksYa. Te puedo ayudar a agendar y/o gestionar tus citas y pedir información. ¿Que deseas hacer? \n\n1- 🗓️ Agendar\n\n2- 🗓️ Reprogramar cita\n\n3- ❌Cancelar Cita\n\n4-  ℹ️ Obtener informacion"));
